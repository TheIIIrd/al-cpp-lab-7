...
int main() {
  ...
  auto future1 =
      std::async(std::launch::async, bubbleSort, std::ref(arr), "Thread 1");
  auto future2 =
      std::async(std::launch::async, bubbleSort, std::ref(arr), "Thread 2");
  ...
  auto future3 =
      std::async(std::launch::async, bubbleSort, std::ref(arr), "Thread 3");
  future3.get();
