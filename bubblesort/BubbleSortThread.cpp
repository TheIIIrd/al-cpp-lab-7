...
int main() {
  ...
  std::thread thread1(bubbleSort, std::ref(arr), "Thread 1", 0, arr.size() / 2);
  std::thread thread2(bubbleSort, std::ref(arr), "Thread 2", arr.size() / 2,
                      arr.size());
  ...
  std::thread thread3(bubbleSort, std::ref(arr), "Thread 3", 0, arr.size());
  thread3.join();
